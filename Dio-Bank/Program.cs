...
namespace Dio_Bank
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            //contas iniciais por motivo de permanencia
            Conta conta = new Conta(tipoConta: (TipoConta)1, 5000, 50, "Romulus");
            Conta conta2 = new Conta(tipoConta: (TipoConta)1, 5600, 50, "Julius");
